...
// void updateRange(int *tree, int ss, int se, int l, int r, int  update, int
// index ) {
//     if (l > se || r < ss) {
//         return;
//     }
...
int32_t main() {
  ...
  // int t;cin>>t;while(t--)
  {
    int j, k, m, ans = 0, cnt = 0, sum = 0, update, indexToUpdate, left, right,
                 no_of_query, queryLeft, queryRight;
