...
void updateRangeLazy(int *tree, int ss, int se, int l, int r, int inc,
                     int index) {
...
void updateRange(int *tree, int ss, int se, int l, int r, int increment,
                 int index) {
  if (l > se || r < ss) {
    return;
  }
...
int32_t main() {
  ...
  // int t;cin>>t;while(t--)
  {
    ...
    int no_of_query = 6;
    // cout << queryLazy(tree, 0, n - 1, 3, 3, 1) << endl;
    while (no_of_query--) {
